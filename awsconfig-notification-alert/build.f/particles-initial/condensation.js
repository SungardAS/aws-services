...
module.exports.initialize = function(cb) {
  ...
  vfs.src(["awsconfig-notification-alert/index_*.js",  "awsconfig-notification-alert/json/*.json", "lib/flow_controller.js", "lib/aws/*.js"],{cwd:'../../..', base:'../../..'})
  .pipe(zip('notificationalert.zip'))
