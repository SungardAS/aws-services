...
var config = require('./particles-initial/config/' + configFile);
console.log(config.s3[0].aws.bucket);

var functionNames = ['billingalert_notifier', 'billingalert_saver'];

var input = {
  "region": null,
  "bucketName": null,
  "keyName": "particles/assets/billingalert.zip",
  "zipFile" : "billingalert.zip",
  "sourceFolder" : "../..",
  "src" : ["billingalert/index.js", "billingalert/index_saver.js", "billingalert/metrics.js", "billingalert/json/*.json", "lib/flow_controller.js", "lib/aws/*.js"]
}
console.log(input);
