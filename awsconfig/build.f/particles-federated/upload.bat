...
aws s3 cp awsconfig.zip s3://sgas.particles-awsconfig.blog.federated.us-east-1/particles/assets/awsconfig.zip --region us-east-1
...
aws s3 cp cloudformation_builder.zip s3://sgas.particles-awsconfig.blog.federated.us-east-1/particles/assets/cloudformation_builder.zip --region us-east-1
