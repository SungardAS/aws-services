...
function BillingAlertSetup() {
  ...
  me.deploy = function(params) {
    params.action = 'deploy';
    _run(params);
  }

  me.clean = function(params) {
    params.action = 'clean';
    _run(params);
  }
  ...
  function _run(params) {
    ...
    var federateAccount = params.federate_awsid;
    var federateRole = params.federate_role;
    var masterAccount = params.master_awsid;
    var masterExternalId = params.master_aws_externalid;
    var billAccount = params.billing_awsid;
    var sim = params.sim;
    var profile = params.profile;
    if (!action || (action != 'deploy' && action != 'clean') || !federateAccount || !federateRole || !masterAccount || !billAccount || !sim) {
      console.log('{"action":"deploy|clean", "federate_awsid":"<federate aws account id>", "federate_role":"<federate role name>", "master_awsid":"<billing master aws account id>", "billing_awsid":"<aws billing account id>", "sim":true|false, "profile":"<profile name>"}');
      return;
    }
    ...
    roles.push({roleArn:'arn:aws:iam::' + account + ':role/' + federateRole, externalId:masterExternalId});
    var sessionName = 'abcde';

    console.log('profile = ' + profile);
    console.log('region = ' + region);
    console.log('federateAccount = ' + federateAccount);
    console.log('federateRole = ' + federateRole);
    ...
    var alarmName = billAccount + '-' + package_json.alarmName;
    ...
    var overAlarmName = billAccount + '-Over' + package_json.alarmName;
    ...
    var IncreasedPercentagesAlarm = {
      ...
      AlarmActions: [],
      AlarmDescription: '',
      Dimensions: [ {Name: 'LinkedAccount', Value: billAccount}, {Name: 'Currency', Value: 'USD'} ],
    ...
    var OverIncreasedPercentagesAlarm = {
      ...
      AlarmActions: [],
      AlarmDescription: '',
      Dimensions: [ {Name: 'LinkedAccount', Value: billAccount}, {Name: 'None', Value: 'Percent'} ],
      InsufficientDataActions: [],
      OKActions: [],
      Unit: 'Percent'
    };
    console.log("####" + overAlarmName);
...
module.exports = BillingAlertSetup
