...
var config = require('./particles-cloudtrail/config/' + configFile);
console.log(config.s3[0].aws.bucket);

var functionNames = ['cloudtrail-checker', 'cloudtrail-enabler', 'cloudtrail-remover'];

var input = {
  "region": null,
  "bucketName": null,
  "keyName": "particles/assets/cloudtrail.zip",
  "zipFile" : "cloudtrail.zip",
  "sourceFolder" : "../..",
  "src" : ["cloudtrail/index_*.js", "cloudtrail/json/*.json", "lib/flow_controller.js", "lib/aws/*.js"]
}
console.log(input);
