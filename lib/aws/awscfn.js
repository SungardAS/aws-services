...
function AWSCfn() {
  ...
  me.createEc2CFNStack = function(input, callback) {
    var self = arguments.callee;
    var cnfparam = {
        StackName: input.params.stackName,
        Capabilities: ['CAPABILITY_IAM'],
        OnFailure: 'ROLLBACK',
        Parameters: [
           {
           ...
           },
           {
              ...
              ParameterValue: input.params.instanceType
           },
           {
              ParameterKey: "PSecurityGroup",
              ParameterValue: input.params.pSgId
           },
           {
              ParameterKey: "ManagementSecurityGroup",
              ParameterValue: input.params.mSgId
           },
           {
              ParameterKey: "PSubnetId",
              ParameterValue: input.params.pSubnetId
           },
           {
              ParameterKey: "ManagementSubnetId",
              ParameterValue: input.params.mSubnetId
           },
           {
              ParameterKey: "VolumeSize",
              ParameterValue: input.params.ebsVolume
           },
           {
              ParameterKey: "VPCId",
              ParameterValue: input.params.vpcId
           ...
           //{
           //   ParameterKey: "OsType",
           //   ParameterValue: input.params.osType
           //},
           {
              ParameterKey: "Hostname",
              ParameterValue: input.params.hostName
           }
         ],
        TemplateURL: input.s3Url //'https://s3-us-west-1.amazonaws.com/temporary-management/ESSTool--ireland.json',
    };
