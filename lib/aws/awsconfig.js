...
function AWSConfig() {
  ...
  me.enableRule = function(input) {
    ...
    var params = {
        ConfigRule:{
            ConfigRuleName:input.rule.ruleName,
            Source: {
                Owner: "AWS",
                SourceIdentifier: input.rule.sourceID
                },
            Scope: {ComplianceResourceTypes: input.rule.resorceType},
            InputParameters: input.rule.params
        }    
    };
