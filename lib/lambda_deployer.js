...
function LambdaDeployer() {
  ...
  /*me.create_role = function(input) {
    var functionChain = [
      ...
      //{func:aws_bucket.findBucket, success:aws_role.findRole, failure:null, error:null},
  ...
  me.deploy = function(input) {
    var functionChain = [
      ...
      {func:aws_role.createInlinePolicy, success:wait, failure:null, error:null},
      {func:wait, success:aws_bucket.findBucket, failure:null, error:null},
