...
var config = require('./particles-volume/config/' + configFile);
console.log(config.s3[0].aws.bucket);

var functionNames = ['volume_tagger'];

var input = {
  "region": null,
  "bucketName": null,
  "keyName": "particles/assets/volume.zip",
  "zipFile" : "volume.zip",
  "sourceFolder" : "../..",
  "src" : ['volume/index.js', 'volume/json/*', 'volume/node_modules/mysql/**/*', 'lib/flow_controller.js', 'lib/aws/*.js']
}
console.log(input);
